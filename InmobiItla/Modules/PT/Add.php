...
$Interface = GetInterface('CREATE_CLIENT');
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="email" class="form-control" name="Mail" placeholder="Enter email" required="true">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Direccion</label>
                  <input type="text" class="form-control" name="address" placeholder="Enter email" required="true">
                </div>
              </div>
              <!-- /.box-body -->
          ...
          <div class="box box-info">
            ...
            <div class="col-md-12">
                ...
                <div class="input-group">
                  ...
                  <input class="form-control" type="text" data-mask="" name="Phone" data-inputmask='"mask": "(999) 999-9999"'>
                </div>
              </div>
                <!-- /.input group -->
              </div>
              ...
              <div class="input-group">
                ...
                <input class="form-control" name="Balance" value="0" type="text">
